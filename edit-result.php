...
$ret = "SELECT tblstudents.StudentName,tblclasses.ClassName from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid limit 1";
...
<?php
   $depart = $_GET['stid'];
   $query = mysqli_query($con, "SELECT Department FROM tblresult WHERE StudentId='$depart' ") or die();
   $resultde = mysqli_fetch_assoc($query);
   echo $resultde["Department"];
...
<?php
   $depart = $_GET['stid'];
   $query = mysqli_query($con, "SELECT term FROM tblresult WHERE StudentId='$depart' ") or die();
   $resultde = mysqli_fetch_assoc($query);
   echo $resultde["term"];
...
<?php
   $depart = $_GET['stid'];
   $query = mysqli_query($con, "SELECT year FROM tblresult WHERE StudentId='$depart' ") or die();
   $resultde = mysqli_fetch_assoc($query);
   echo $resultde["year"];
