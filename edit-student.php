...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,Departments=:Department,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status,ClassId=:classid where StudentId=:stid ";
...
<div class="col-sm-10">
<input type="text" name="studentid" class="form-control" readonly value="<?php echo htmlentities($result->RollId)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
 <select name="Department" class="form-control" id="default" required="required">
                                                        <option value="<?php echo htmlentities($result->Departments)?>"><?php echo htmlentities($result->Departments)?></option>
                                                        <?php $sql = "SELECT * from tbldepartments";
                                                            ...
                                                            {   ?>
                                                        <option value="<?php echo htmlentities($resultdep->DepartmentName); ?>">
...
<?php }?>
            ...
            <select name="class" class="form-control" id="default">
                                                        <div class="col-sm-10">
                                                            <option value="<?php echo htmlentities($result->ClassId)?>"><?php echo htmlentities($result->ClassName)?></option>
...
<?php }} ?>                                                    
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            ...
                                                            <a href="manage-students.php" class="btn btn-primary" style="float: right;background: black;color: white;">
                                                    Manage students
                                            </a>
                                                        </div>
                                                    </div>
