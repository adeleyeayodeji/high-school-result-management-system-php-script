    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                <a href="add-result.php" class="btn btn-primary" style="background: black;color: white;">
                                                    Add new result
                                            </a><br><br>
...
<td>
     <a href="manage-results.php?del=<?php echo htmlentities($result->StudentId);?>" onclick="confirm('Do you really want to delete this decleared');"><i class="fa fa-remove" title="Delete Class" style="color: red;"></i> </a>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
