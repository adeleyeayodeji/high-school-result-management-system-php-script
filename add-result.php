...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,ClassId,SubjectId,marks,term,year,Department) VALUES(:studentid,:class,:sid,:marks,:term,:year,:Department)";
...
<?php }} ?>
                                                    ...
                                                    <select name="term" class="form-control stid" required="required">
                                                       ...
                                                       <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <input type="text" name="year" class="form-control" placeholder="2019, 2020">
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                    <select name="Department" class="form-control stid" id="Department" required="required">
