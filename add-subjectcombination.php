...
if($lastInsertId)
{
$query = mysqli_query($con, "SELECT * FROM tblsubjects WHERE id='$subject' ") or die("Error Submiting");
...
<?php }} ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            ...
                                                            <a href="manage-subjectcombination.php" class="btn btn-primary" style="float: right;background: black;color: white;">
                                                    Manage Combination
                                            </a>
                                                        </div>
                                                    </div>
