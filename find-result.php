                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="studentid" placeholder="Enter Your Student Id" autocomplete="off" name="studentid">
                                	</div>
                               <div class="form-group">
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © School Name Result Checking</small><br><a href="adlog.php" target="_blank" style="color: white;"><small>Admin</small></p>
                    </div>
