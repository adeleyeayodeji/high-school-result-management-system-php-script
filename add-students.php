...
$RollId = strtolower(str_replace(' ', '%', trim($_POST['fullanme']))).substr(rand(),0,4);
$gender=$_POST['gender']; 
$classid=$_POST['class']; 
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,Departments,Gender,ClassId,DOB,Status,RollId) VALUES(:studentname,:Department,:gender,:classid,:dob,:status,:rollid)";
