...
<td>
    <a href="manage-subjectcombination.php?del=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to delete this subject');"><i class="fa fa-remove" title="Delete Subject" style="color: red;"></i> </a>
